...
if($_POST){
    ...
    $contactController->update($newContact);
...
<form method="post" enctype="multipart/form-data" >
        ...
        <input type="text" name="nom" value="<?= $contact->getNom() ?>"placeholder="Le Nom de l'agent" id="nom" class="form-control" minlength="3" maxlength="40">
