...
<form method="post" enctype="multipart/form-data" >
        ...
        <input type="text" name="date_de_naissance" value="<?= $cible->getDate_de_naissance() ?>" placeholder="La Date de naissance" id="date_de_naissance" class="form-control" minlength="3" maxlength="40">
